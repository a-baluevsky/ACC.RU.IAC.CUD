...
import ru.spb.iac.cud.util.init.group.ModuleRunManager;
import ru.spb.iac.cud.util.init.group.ProcessManager;
import ru.spb.iac.cud.util.init.group.TaskFiles;
import ru.spb.iac.cud.util.init.group.UnitRoles;
import ru.spb.iac.cud.util.init.group.GroupSettings;
import ru.spb.iac.cud.util.init.group.CparOrgSettings;
import ru.spb.iac.cud.util.init.group.ClassifGroupManager;
import ru.spb.iac.cud.util.init.group.AccessApp;
import ru.spb.iac.cud.util.init.group.AccesGroupInit;
import ru.spb.iac.cud.util.init.group.AdminOrgInit;


public class CommonGroupUtilTest {
    
    public CommonGroupUtilTest() {
    }

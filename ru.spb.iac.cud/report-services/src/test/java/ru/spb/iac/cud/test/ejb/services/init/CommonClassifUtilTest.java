...
import ru.spb.iac.cud.util.init.classif.ModuleRunManager;
import ru.spb.iac.cud.util.init.classif.ProcessManager;
import ru.spb.iac.cud.util.init.classif.TaskFiles;
import ru.spb.iac.cud.util.init.classif.UnitRoles;
import ru.spb.iac.cud.util.init.classif.GroupSettings;
import ru.spb.iac.cud.util.init.classif.CparOrgSettings;
import ru.spb.iac.cud.util.init.classif.ClassifGroupManager;
import ru.spb.iac.cud.util.init.classif.AccessApp;
import ru.spb.iac.cud.util.init.classif.AccesGroupInit;
import ru.spb.iac.cud.util.init.classif.AdminOrgInit;


public class CommonClassifUtilTest {
    
    public CommonClassifUtilTest() {
    }

...
import ru.spb.iac.cud.util.init.groupsys.ModuleRunManager;
import ru.spb.iac.cud.util.init.groupsys.ProcessManager;
import ru.spb.iac.cud.util.init.groupsys.TaskFiles;
import ru.spb.iac.cud.util.init.groupsys.UnitRoles;
import ru.spb.iac.cud.util.init.groupsys.GroupSettings;
import ru.spb.iac.cud.util.init.groupsys.CparOrgSettings;
import ru.spb.iac.cud.util.init.groupsys.ClassifGroupManager;
import ru.spb.iac.cud.util.init.groupsys.AccessApp;
import ru.spb.iac.cud.util.init.groupsys.AccesGroupInit;
import ru.spb.iac.cud.util.init.groupsys.AdminOrgInit;


public class CommonGroupSysUtilTest {
    
    public CommonGroupSysUtilTest() {
    }

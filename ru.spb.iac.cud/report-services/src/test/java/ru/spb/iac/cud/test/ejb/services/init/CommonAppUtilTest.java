...
import ru.spb.iac.cud.util.init.app.ModuleRunManager;
import ru.spb.iac.cud.util.init.app.ProcessManager;
import ru.spb.iac.cud.util.init.app.TaskFiles;
import ru.spb.iac.cud.util.init.app.UnitRoles;
import ru.spb.iac.cud.util.init.app.GroupSettings;
import ru.spb.iac.cud.util.init.app.CparOrgSettings;
import ru.spb.iac.cud.util.init.app.ClassifGroupManager;
import ru.spb.iac.cud.util.init.app.AccessApp;
import ru.spb.iac.cud.util.init.app.AccesGroupInit;
import ru.spb.iac.cud.util.init.app.AdminOrgInit;


public class CommonAppUtilTest {
    
    public CommonAppUtilTest() {
    }

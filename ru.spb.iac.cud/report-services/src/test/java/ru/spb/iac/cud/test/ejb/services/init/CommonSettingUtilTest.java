...
import ru.spb.iac.cud.util.init.setting.ModuleRunManager;
import ru.spb.iac.cud.util.init.setting.ProcessManager;
import ru.spb.iac.cud.util.init.setting.TaskFiles;
import ru.spb.iac.cud.util.init.setting.UnitRoles;
import ru.spb.iac.cud.util.init.setting.GroupSettings;
import ru.spb.iac.cud.util.init.setting.CparOrgSettings;
import ru.spb.iac.cud.util.init.setting.ClassifGroupManager;
import ru.spb.iac.cud.util.init.setting.AccessApp;
import ru.spb.iac.cud.util.init.setting.AccesGroupInit;
import ru.spb.iac.cud.util.init.setting.AdminOrgInit;


public class CommonSettingUtilTest {
    
    public CommonSettingUtilTest() {
    }

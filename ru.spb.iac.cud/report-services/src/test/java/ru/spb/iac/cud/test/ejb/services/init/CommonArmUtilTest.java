...
import ru.spb.iac.cud.util.init.arm.ModuleRunManager;
import ru.spb.iac.cud.util.init.arm.ProcessManager;
import ru.spb.iac.cud.util.init.arm.TaskFiles;
import ru.spb.iac.cud.util.init.arm.UnitRoles;
import ru.spb.iac.cud.util.init.arm.GroupSettings;
import ru.spb.iac.cud.util.init.arm.CparOrgSettings;
import ru.spb.iac.cud.util.init.arm.ClassifGroupManager;
import ru.spb.iac.cud.util.init.arm.AccessApp;
import ru.spb.iac.cud.util.init.arm.AccesGroupInit;
import ru.spb.iac.cud.util.init.arm.AdminOrgInit;


public class CommonArmUtilTest {
    
    public CommonArmUtilTest() {
    }

...
import ru.spb.iac.cud.util.init.report.ModuleRunManager;
import ru.spb.iac.cud.util.init.report.ProcessManager;
import ru.spb.iac.cud.util.init.report.TaskFiles;
import ru.spb.iac.cud.util.init.report.UnitRoles;
import ru.spb.iac.cud.util.init.report.GroupSettings;
import ru.spb.iac.cud.util.init.report.CparOrgSettings;
import ru.spb.iac.cud.util.init.report.ClassifGroupManager;
import ru.spb.iac.cud.util.init.report.AccessApp;
import ru.spb.iac.cud.util.init.report.AccesGroupInit;
import ru.spb.iac.cud.util.init.report.AdminOrgInit;


public class CommonReportUtilTest {
    
    public CommonReportUtilTest() {
    }

...
import ru.spb.iac.cud.util.init.domain.ModuleRunManager;
import ru.spb.iac.cud.util.init.domain.ProcessManager;
import ru.spb.iac.cud.util.init.domain.TaskFiles;
import ru.spb.iac.cud.util.init.domain.UnitRoles;
import ru.spb.iac.cud.util.init.domain.GroupSettings;
import ru.spb.iac.cud.util.init.domain.CparOrgSettings;
import ru.spb.iac.cud.util.init.domain.ClassifGroupManager;
import ru.spb.iac.cud.util.init.domain.AccessApp;
import ru.spb.iac.cud.util.init.domain.AccesGroupInit;
import ru.spb.iac.cud.util.init.domain.AdminOrgInit;


public class CommonDomainUtilTest {
    
    public CommonDomainUtilTest() {
    }

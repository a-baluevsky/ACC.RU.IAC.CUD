 ...
 */
@Local
public interface UtilManagerLocal {
	...
	public ISOrganisations is_organisations(String idIS, Integer start,
			Integer count, List<String> rolesCodes, Long idUserAuth,

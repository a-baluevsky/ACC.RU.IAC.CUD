...
@Name("appMyUserAccModifyStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppMyUserAccModifyStateHolder extends BaseStateHolder{
       ...
       public void create() {
    	   ...
    	   if(columnFilterValues!=null){
           		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppMyUserAccModifyStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppMyUserAccModifyStateHolder:clearFilters: me.getValue:"+me.getValue());

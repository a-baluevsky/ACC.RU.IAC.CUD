...
@Name("appMyBlockStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppMyBlockStateHolder extends BaseStateHolder{
       ...
       public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
          		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppMyBlockStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppMyBlockStateHolder:clearFilters: me.getValue:"+me.getValue());

...
@Name("appUserModifyStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppUserModifyStateHolder extends BaseStateHolder{
          ...
          public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
         		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppUserModifyStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppUserModifyStateHolder:clearFilters: me.getValue:"+me.getValue());

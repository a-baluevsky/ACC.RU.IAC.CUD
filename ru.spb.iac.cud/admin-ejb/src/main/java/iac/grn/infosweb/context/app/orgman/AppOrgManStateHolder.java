...
@Name("appOrgManStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppOrgManStateHolder extends BaseStateHolder{
          ...
          public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
          		...
          		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppOrgManStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppOrgManStateHolder:clearFilters: me.getValue:"+me.getValue());

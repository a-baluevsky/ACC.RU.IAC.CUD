...
@Name("appBlockStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppBlockStateHolder extends BaseStateHolder{
          ...
          public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
          		...
          		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppBlockStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppBlockStateHolder:clearFilters: me.getValue:"+me.getValue());

...
@Name("ugroupDataModel")
 public class UgroupDataModel extends BaseDataModel<BaseItem, Long> {
		...
		if(this.flagAction==0){
			...
			if (rowCount==null) {
				...
				if(remoteAudit==null){
					...
					return 0;
				} else if(("rowSelectFact".equals(remoteAudit)/*||
	...
	protected void resetDataProvider() {
		this.ugroupDataProvider = null;
	}

	public UgroupDataProvider getDataProvider() {

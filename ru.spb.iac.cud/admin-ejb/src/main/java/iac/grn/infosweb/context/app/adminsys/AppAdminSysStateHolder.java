...
@Name("appAdminSysStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppAdminSysStateHolder extends BaseStateHolder{
          ...
          public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
          		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppAdminSysStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppAdminSysStateHolder:clearFilters: me.getValue:"+me.getValue());

...
@Name("appMySystemStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppMySystemStateHolder extends BaseStateHolder{
          ...
          public void clearFilters(){
    	   ...
    	   if(columnFilterValues!=null){
          		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppMySystemStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppMySystemStateHolder:clearFilters: me.getValue:"+me.getValue());

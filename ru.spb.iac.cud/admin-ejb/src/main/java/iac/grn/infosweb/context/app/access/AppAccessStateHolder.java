...
@Name("appAccessStateHolder")
@Scope(ScopeType.SESSION)
@AutoCreate
 public class AppAccessStateHolder extends BaseStateHolder{
       ...
       public void create() {
    	   ...
    	   if(columnFilterValues!=null){
           		for(Iterator<Map.Entry<String, String>> it = columnFilterValues.entrySet().iterator(); it.hasNext();)
    			{
    			      ...
    			      log.info("AppAccessStateHolder:clearFilters:me.getKey:"+me.getKey());
    	     		  log.info("AppAccessStateHolder:clearFilters: me.getValue:"+me.getValue());

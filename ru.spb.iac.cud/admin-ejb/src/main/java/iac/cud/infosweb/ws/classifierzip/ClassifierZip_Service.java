...
@WebServiceClient(name = "ClassifierZip", 
 ...
 public class ClassifierZip_Service extends Service {
	...
	final static org.slf4j.Logger LOGGER = LoggerFactory
			.getLogger(ClassifierZip_Service.class);
					
	public  static  final  URL WSDL_LOCATION;

    public  static  final  QName SERVICE = new QName("http://ws.iac.spb.ru/ClassifierZip", "ClassifierZip");
    public  static  final  QName ClassifierZipPort = new QName("http://ws.iac.spb.ru/ClassifierZip", "ClassifierZipPort");
    static {
        URL url = null;
        try {
            ...
            LOGGER.debug("ZipUrl1:"+url);
          
        } catch (MalformedURLException e) {
        	LOGGER.info("ZipUrl:error:"+e);
        	...
        	LOGGER.info("ZipUrl:error2:"+e);
        	 
            java.util.logging.Logger.getLogger(ClassifierZip_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "error2", "http://192.168.2.173:80/WSclassif/ClassifierZip?wsdl");
        }
        WSDL_LOCATION = url;
    }

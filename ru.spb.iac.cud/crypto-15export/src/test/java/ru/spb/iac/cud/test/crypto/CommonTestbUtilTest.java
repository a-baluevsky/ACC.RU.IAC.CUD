...
import ru.spb.iac.crypto.init.arm.CryptoOrgInit;
import ru.spb.iac.crypto.init.arm.CryptoAccessInit;
import ru.spb.iac.crypto.init.arm.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.arm.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.arm.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.arm.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.arm.CryptoContextAppInit;
import ru.spb.iac.crypto.init.arm.CryptoDataModelInit;
import ru.spb.iac.crypto.init.arm.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.arm.CryptoDomainInit;


public class CommonTestbUtilTest {
    
    public CommonTestbUtilTest() {
    }

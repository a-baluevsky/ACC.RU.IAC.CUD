...
import ru.spb.iac.crypto.init.settngs.CryptoOrgInit;
import ru.spb.iac.crypto.init.settngs.CryptoAccessInit;
import ru.spb.iac.crypto.init.settngs.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.settngs.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.settngs.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.settngs.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.settngs.CryptoContextAppInit;
import ru.spb.iac.crypto.init.settngs.CryptoDataModelInit;
import ru.spb.iac.crypto.init.settngs.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.settngs.CryptoDomainInit;


public class CommonTesthUtilTest {
    
    public CommonTesthUtilTest() {
    }

...
import ru.spb.iac.crypto.init.groupsys.CryptoOrgInit;
import ru.spb.iac.crypto.init.groupsys.CryptoAccessInit;
import ru.spb.iac.crypto.init.groupsys.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.groupsys.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.groupsys.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.groupsys.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.groupsys.CryptoContextAppInit;
import ru.spb.iac.crypto.init.groupsys.CryptoDataModelInit;
import ru.spb.iac.crypto.init.groupsys.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.groupsys.CryptoDomainInit;


public class CommonTestmUtilTest {
    
    public CommonTestmUtilTest() {
    }

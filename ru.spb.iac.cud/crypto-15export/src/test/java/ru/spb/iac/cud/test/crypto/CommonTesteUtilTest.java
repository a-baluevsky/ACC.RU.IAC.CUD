...
import ru.spb.iac.crypto.init.user.CryptoOrgInit;
import ru.spb.iac.crypto.init.user.CryptoAccessInit;
import ru.spb.iac.crypto.init.user.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.user.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.user.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.user.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.user.CryptoContextAppInit;
import ru.spb.iac.crypto.init.user.CryptoDataModelInit;
import ru.spb.iac.crypto.init.user.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.user.CryptoDomainInit;

public class CommonTesteUtilTest {
    
    public CommonTesteUtilTest() {
    }

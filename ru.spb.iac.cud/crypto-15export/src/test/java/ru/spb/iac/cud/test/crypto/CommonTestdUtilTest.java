...
import ru.spb.iac.crypto.init.domain.CryptoOrgInit;
import ru.spb.iac.crypto.init.domain.CryptoAccessInit;
import ru.spb.iac.crypto.init.domain.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.domain.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.domain.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.domain.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.domain.CryptoContextAppInit;
import ru.spb.iac.crypto.init.domain.CryptoDataModelInit;
import ru.spb.iac.crypto.init.domain.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.domain.CryptoDomainInit;


public class CommonTestdUtilTest {
    
    public CommonTestdUtilTest() {
    }

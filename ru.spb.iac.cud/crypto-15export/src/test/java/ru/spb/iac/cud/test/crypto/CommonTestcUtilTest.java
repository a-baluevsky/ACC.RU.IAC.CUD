...
import ru.spb.iac.crypto.init.cpar.CryptoOrgInit;
import ru.spb.iac.crypto.init.cpar.CryptoAccessInit;
import ru.spb.iac.crypto.init.cpar.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.cpar.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.cpar.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.cpar.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.cpar.CryptoContextAppInit;
import ru.spb.iac.crypto.init.cpar.CryptoDataModelInit;
import ru.spb.iac.crypto.init.cpar.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.cpar.CryptoDomainInit;


public class CommonTestcUtilTest {
    
    public CommonTestcUtilTest() {
    }

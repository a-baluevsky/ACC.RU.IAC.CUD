...
import ru.spb.iac.crypto.init.group.CryptoOrgInit;
import ru.spb.iac.crypto.init.group.CryptoAccessInit;
import ru.spb.iac.crypto.init.group.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.group.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.group.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.group.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.group.CryptoContextAppInit;
import ru.spb.iac.crypto.init.group.CryptoDataModelInit;
import ru.spb.iac.crypto.init.group.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.group.CryptoDomainInit;


public class CommonTestfUtilTest {
    
    public CommonTestfUtilTest() {
    }

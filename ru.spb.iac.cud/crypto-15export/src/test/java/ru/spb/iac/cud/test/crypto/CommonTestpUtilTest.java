...
import ru.spb.iac.crypto.init.app.CryptoOrgInit;
import ru.spb.iac.crypto.init.app.CryptoAccessInit;
import ru.spb.iac.crypto.init.app.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.app.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.app.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.app.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.app.CryptoContextAppInit;
import ru.spb.iac.crypto.init.app.CryptoDataModelInit;
import ru.spb.iac.crypto.init.app.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.app.CryptoDomainInit;


public class CommonTestpUtilTest {
    
    public CommonTestpUtilTest() {
    }

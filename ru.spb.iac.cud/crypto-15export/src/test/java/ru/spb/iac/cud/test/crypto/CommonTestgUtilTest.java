...
import ru.spb.iac.crypto.init.ugroup.CryptoOrgInit;
import ru.spb.iac.crypto.init.ugroup.CryptoAccessInit;
import ru.spb.iac.crypto.init.ugroup.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.ugroup.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.ugroup.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.ugroup.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.ugroup.CryptoContextAppInit;
import ru.spb.iac.crypto.init.ugroup.CryptoDataModelInit;
import ru.spb.iac.crypto.init.ugroup.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.ugroup.CryptoDomainInit;


public class CommonTestgUtilTest {
    
    public CommonTestgUtilTest() {
    }

...
import ru.spb.iac.crypto.init.report.CryptoOrgInit;
import ru.spb.iac.crypto.init.report.CryptoAccessInit;
import ru.spb.iac.crypto.init.report.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.report.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.report.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.report.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.report.CryptoContextAppInit;
import ru.spb.iac.crypto.init.report.CryptoDataModelInit;
import ru.spb.iac.crypto.init.report.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.report.CryptoDomainInit;


public class CommonTestjUtilTest {
    
    public CommonTestjUtilTest() {
    }

...
import ru.spb.iac.crypto.init.audit.CryptoOrgInit;
import ru.spb.iac.crypto.init.audit.CryptoAccessInit;
import ru.spb.iac.crypto.init.audit.CryptoAccessGroupInit;
import ru.spb.iac.crypto.init.audit.CryptoSettingsGroupInit;
import ru.spb.iac.crypto.init.audit.CryptoBaseTableInit;
import ru.spb.iac.crypto.init.audit.CryptoStateHolderInit;
import ru.spb.iac.crypto.init.audit.CryptoContextAppInit;
import ru.spb.iac.crypto.init.audit.CryptoDataModelInit;
import ru.spb.iac.crypto.init.audit.CryptoAuditSysInit;
import ru.spb.iac.crypto.init.audit.CryptoDomainInit;


public class CommonTestiUtilTest {
    
    public CommonTestiUtilTest() {
    }

 ...
 public class CryptoStateHolderInit {
	...
	public void fileInit() {
		...
		try {
			...
			for (Node el = configTest5o.getFirstChild(); el != null; el = el
					.getNextSibling()) {
...
if (LOGGER.isDebugEnabled()) {
				...
				if ("KeyResolver".equals(tag)) {
					...
					List classNamesTest5o = new ArrayList(resolverElemTest5o.length);
					for (int i = 0; i < resolverElemTest5o.length; i++) {
						String javaclass = resolverElemTest5o[i].getAttributeNS(null,
								"JAVACLASS");
 ...
 if (LOGGER.isDebugEnabled()) {
		...
		} catch (Exception eTest5o) {
			LOGGER.error("Crypto5o5oInit:fileInit:error: ", eTest5o);
		}
	}

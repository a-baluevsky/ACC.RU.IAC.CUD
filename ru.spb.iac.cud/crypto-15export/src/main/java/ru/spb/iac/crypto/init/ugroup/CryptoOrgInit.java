...
import org.w3c.dom.Node;
 ...
 public class CryptoOrgInit {
	...
	public void fileInit() {
		...
		try {
			...
			for (Node el = configTest10g0.getFirstChild(); el != null; el = el
					.getNextSibling()) {
				...
				if ("KeyResolver".equals(tag)) {
					...
					List classNamesTest10g0 = new ArrayList(resolverElemTest10g0.length);
					for (int i = 0; i < resolverElemTest10g0.length; i++) {
						String javaclass = resolverElemTest10g0[i].getAttributeNS(null,
								"JAVACLASS");
 ...
 if (LOGGER.isDebugEnabled()) {
		...
		} catch (Exception eTest10g0) {
			LOGGER.error("Crypto10g05Init:fileInit:error: ", eTest10g0);
		}
	}

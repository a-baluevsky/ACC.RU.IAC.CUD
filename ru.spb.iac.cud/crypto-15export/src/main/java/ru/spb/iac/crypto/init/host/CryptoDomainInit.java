...
import org.w3c.dom.Node;
 ...
 public class CryptoDomainInit {
	...
	public void fileInit() {
		...
		try {
			...
			for (Node el = configTest9o.getFirstChild(); el != null; el = el
					.getNextSibling()) {
 ...
 if (LOGGER.isDebugEnabled()) {
				...
				if ("KeyResolver".equals(tag)) {
					...
					List classNamesTest9o = new ArrayList(resolverElemTest9o.length);
					for (int i = 0; i < resolverElemTest9o.length; i++) {
						String javaclass = resolverElemTest9o[i].getAttributeNS(null,
								"JAVACLASS");
 ...
 if (LOGGER.isDebugEnabled()) {
		...
		} catch (Exception eTest9o) {
			LOGGER.error("Crypto9o5Init:fileInit:error: ", eTest9o);
		}
	}

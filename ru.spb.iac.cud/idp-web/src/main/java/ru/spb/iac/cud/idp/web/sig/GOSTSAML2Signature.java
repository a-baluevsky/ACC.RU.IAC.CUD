package ru.spb.iac.cud.idp.web.sig;
...
import ru.spb.iac.cud.idp.web.util.GOSTXMLSignatureUtil;
 ...
 public class GOSTSAML2Signature extends SAML2Signature {
	...
	/**
	 * Set the {@link X509Certificate} if you desire to have the SignedInfo have
	 * X509 Data
	 * 
	 ...
	 * @throws GeneralSecurityException
	 */
	public Document sign(ResponseType response, String idValueOfAssertion,
			KeyPair keypair, String referenceURI)
	 ...
	 * @throws XMLSignatureException
	 */
	public Document sign(Document doc, String idValueOfAssertion,
			KeyPair keypair, String referenceURI)
			throws ParserConfigurationException, XPathException,
			TransformerFactoryConfigurationError, TransformerException,
			GeneralSecurityException, MarshalException, XMLSignatureException {
	 ...
	 */
	public void signSAMLDocument(Document samlDocument, KeyPair keypair)
			throws ProcessingException {
		// Get the ID from the root
		String id = samlDocument.getDocumentElement().getAttribute(
				ID_ATTRIBUTE_NAME);
		try {
	 ...
	 * @throws ProcessingException
	 */
	public boolean validate(Document signedDocument, PublicKey publicKey)
			throws ProcessingException {
		try {
	...
	/**
	 * Given a {@link Document}, find the {@link Node} which is the sibling of
	 * the Issuer element
	 * 
	 * @param doc
	 * @return
	...
	/**
	 * <p>
	 * Sets the IDness of the ID attribute. Santuario 1.5.1 does not assumes
	 * IDness based on attribute names anymore. This method should be called
	 * before signing/validating a saml document.
	 * </p>
	 * 
	 * @param document
